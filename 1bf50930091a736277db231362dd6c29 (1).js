...
;// bundle: headerinit___60656c996ec979a063b127996c8045af_m
;// files: GPTAdScript.js, leancore/libs/json3.min.js, roblox.js, leancore/RobloxHeaderInit.js, CharacterSelect.js, MadStatus.js, jquery.cookie.js

;// GPTAdScript.js
var googletag=googletag||{};googletag.cmd=googletag.cmd||[],function(){var n=document.createElement("script"),i,t;n.async=!0,n.type="text/javascript",i="https:"==document.location.protocol,n.src=(i?"https:":"http:")+"//web.archive.org/web/20150111022309/http://www.googletagservices.com/tag/js/gpt.js",t=document.getElementsByTagName("script")[0],t.parentNode.insertBefore(n,t)}();
...
;// CharacterSelect.js
typeof Roblox=="undefined"&&(Roblox={}),Roblox.CharacterSelect=function(){function r(){return n.genderID=t.male,i(1,"Male",t.male),!1}function u(){return n.genderID=t.female,i(0,"Female",t.female),!1}function i(t,i,r){$.modal.close(".GuestModePromptModal"),n.robloxLaunchFunction(r)}function f(){$("#GuestModePrompt_BoyGirl").modal({overlayClose:!0,escClose:!0,opacity:80,overlayCss:{backgroundColor:"#000"},onShow:e})}function e(n){if(n.container.innerHeight()==15){var t=-Math.floor($("#GuestModePrompt_BoyGirl").innerHeight()/2);$("#GuestModePrompt_BoyGirl").css({position:"relative",top:t+"px"})}}function o(){$.modal.close(".GuestModePromptModal")}var t={male:2,female:3},n;return $(function(){$(".VisitButtonGirlGuest").click(u),$(".VisitButtonBoyGuest").click(r)}),n={robloxLaunchFunction:function(){},genderID:null,show:f,hide:o,placeid:undefined}}();

;// MadStatus.js
MadStatus={running:!1,init:function(n,t,i,r){(MadStatus.running||MadStatus.timeout||MadStatus.resumeTimeout)&&MadStatus.stop(),MadStatus.updateInterval=i?i:2e3,MadStatus.fadeInterval=r?r:1e3,MadStatus.timeout=null,MadStatus.resumeTimeout=null,MadStatus.running=!0,MadStatus.field=n,MadStatus.backBuffer=t,MadStatus.field.show(),MadStatus.backBuffer.hide()},newLib:function(){return MadStatus.participle[Math.floor(Math.random()*MadStatus.participle.length)]+" "+MadStatus.modifier[Math.floor(Math.random()*MadStatus.modifier.length)]+" "+MadStatus.subject[Math.floor(Math.random()*MadStatus.subject.length)]+"..."},start:function(){MadStatus.timeout==null&&(MadStatus.timeout=setInterval("MadStatus.update()",MadStatus.updateInterval),MadStatus.running=!0)},stop:function(n){clearInterval(MadStatus.timeout),MadStatus.timeout=null,clearTimeout(MadStatus.resumeTimeout),MadStatus.resumeTimeout=null,MadStatus.field[0].innerHTML=typeof n!=typeof undefined?n:"",MadStatus.running=!1},manualUpdate:function(n,t,i){(MadStatus.timeout||MadStatus.resumeTimeout)&&MadStatus.stop(),this.update(n,i),t&&(MadStatus.resumeTimeout=setTimeout("MadStatus.start()",1e3))},update:function(n,t){(MadStatus.backBuffer[0].innerHTML=typeof n!=typeof undefined?n:this.newLib(),typeof t==typeof undefined||t!=!1)&&(this.field.hide(),this.backBuffer.fadeIn(this.fadeInterval+2,function(){MadStatus.field[0].innerHTML=MadStatus.backBuffer[0].innerHTML,MadStatus.field.show(),MadStatus.backBuffer.hide()}))}},$(function(){MadStatus.Resources&&(MadStatus.participle=[MadStatus.Resources.accelerating,MadStatus.Resources.aggregating,MadStatus.Resources.allocating,MadStatus.Resources.acquiring,MadStatus.Resources.automating,MadStatus.Resources.backtracing,MadStatus.Resources.bloxxing,MadStatus.Resources.bootstrapping,MadStatus.Resources.calibrating,MadStatus.Resources.correlating,MadStatus.Resources.denoobing,MadStatus.Resources.deionizing,MadStatus.Resources.deriving,MadStatus.Resources.energizing,MadStatus.Resources.filtering,MadStatus.Resources.generating,MadStatus.Resources.indexing,MadStatus.Resources.loading,MadStatus.Resources.noobing,MadStatus.Resources.optimizing,MadStatus.Resources.oxidizing,MadStatus.Resources.queueing,MadStatus.Resources.parsing,MadStatus.Resources.processing,MadStatus.Resources.rasterizing,MadStatus.Resources.reading,MadStatus.Resources.registering,MadStatus.Resources.rerouting,MadStatus.Resources.resolving,MadStatus.Resources.sampling,MadStatus.Resources.updating,MadStatus.Resources.writing],MadStatus.modifier=[MadStatus.Resources.blox,MadStatus.Resources.countzero,MadStatus.Resources.cylon,MadStatus.Resources.data,MadStatus.Resources.ectoplasm,MadStatus.Resources.encryption,MadStatus.Resources.event,MadStatus.Resources.farnsworth,MadStatus.Resources.bebop,MadStatus.Resources.fluxcapacitor,MadStatus.Resources.fusion,MadStatus.Resources.game,MadStatus.Resources.gibson,MadStatus.Resources.host,MadStatus.Resources.mainframe,MadStatus.Resources.metaverse,MadStatus.Resources.nerfherder,MadStatus.Resources.neutron,MadStatus.Resources.noob,MadStatus.Resources.photon,MadStatus.Resources.profile,MadStatus.Resources.script,MadStatus.Resources.skynet,MadStatus.Resources.tardis,MadStatus.Resources.virtual],MadStatus.subject=[MadStatus.Resources.analogs,MadStatus.Resources.blocks,MadStatus.Resources.cannon,MadStatus.Resources.channels,MadStatus.Resources.core,MadStatus.Resources.database,MadStatus.Resources.dimensions,MadStatus.Resources.directives,MadStatus.Resources.engine,MadStatus.Resources.files,MadStatus.Resources.gear,MadStatus.Resources.index,MadStatus.Resources.layer,MadStatus.Resources.matrix,MadStatus.Resources.paradox,MadStatus.Resources.parameters,MadStatus.Resources.parsecs,MadStatus.Resources.pipeline,MadStatus.Resources.players,MadStatus.Resources.ports,MadStatus.Resources.protocols,MadStatus.Resources.reactors,MadStatus.Resources.sphere,MadStatus.Resources.spooler,MadStatus.Resources.stream,MadStatus.Resources.switches,MadStatus.Resources.table,MadStatus.Resources.targets,MadStatus.Resources.throttle,MadStatus.Resources.tokens,MadStatus.Resources.torpedoes,MadStatus.Resources.tubes])});
...
/*
     FILE ARCHIVED ON 02:23:09 Jan 11, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:18:18 May 06, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.774
  load_resource: 277.93 (2)
  PetaboxLoader3.resolve: 173.279 (2)
  PetaboxLoader3.datanode: 78.589 (2)
*/